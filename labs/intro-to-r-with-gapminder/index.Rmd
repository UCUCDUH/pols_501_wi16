...
This package contains country-level data from [Gapminder.org](https://gapminder.org) on income and life expectancy.
...
gapminder[gapminder$country == "United States", c("year", "gdpPercap", "lifeExp")]
gapminder[gapminder$country == "United States", c("year", "gdpPercap", "lifeExp")]
...
gapminder[gapminder$country %in% c("United States", "France", "Germany") & gapminder$year == 2007, ]
gapminder[gapminder$country %in% c("United States", "France", "Germany") & gapminder$year > 2000, ]
gapminder[gapminder$country %in% c("United States", "France", "Germany") & gapminder$year %in% c(2000, 2007), ]
```
...
ggplot(gapminder2007, aes(x = log_gdp_per_cap, y = log_life_exp,
                      colour = continent,
                      size = pop)) +
  geom_point() +
