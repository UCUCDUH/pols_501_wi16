...
```{r}
p + geom_point() + geom_smooth(se = FALSE) + geom_smooth(method = 'lm", se = FALSE)
```
...
p + geom_point() + geom_smooth(se = FALSE, col = "red") + 
                   geom_smooth(method =f"lm", se = FALSE, col = "blue")
```
