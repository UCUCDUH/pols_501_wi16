...
BLOG_TITLE = "POL S/CS&SS 501: Advanced Research Design & Analysis"  # (translatable)
...
MARKDOWN_EXTENSIONS = ['extra', 'smarty', 'toc', 'fenced_code', 'codehilite']
