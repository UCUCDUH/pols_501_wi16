...
[^3]: The **stringr** package contains many functions for processing strings. See the [introduction](https://cran.r-project.org/web/packages/stringr/vignettes/stringr.html) or the *R for Data Science* chapeter on [Strings](http://r4ds.had.co.nz/strings.html) for more information on it.
