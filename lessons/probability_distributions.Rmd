...
SMISS (p.73): "Uncertainty about the characteristics of a wole that remains after observing a part"
...
For a particular case (since we randomly sample 10 countries, each time we repeat the analysis we get sligthly different results) we obtain that:
...
Remember that this is a simplified datset for the Baum and Zhukov's (2015) *JPR* article where the variable **n_articles** is the number of news stories that newspapers from these countries dedicated to talk about the Lybian Civil Crisis.
