...
This is an introduction to the **dplyr** and **tidyr** pacakges for data wrangling using the `gapminder` data from the **gapminder** package. For other introductions see the vignettes for [dplyr](https://cran.r-project.org/web/packages/dplyr/index.html) and [tidyr](https://cran.r-project.org/web/packages/tidyr/index.html), and the [R for Data Science](http://r4ds.had.co.nz/) chapters [Relational Data](http://r4ds.had.co.nz/relational-data.html), [Tidy Data](http://r4ds.had.co.nz/tidy.html), and [Data Transformation](http://r4ds.had.co.nz/transform.html).
...
It is tedious to mutate mutiple columns. To apply one or more functions to one or more columns, use `mutate_each`,
```{r}
