...
voting turnout data from the 1992 Americal National Election Survey.
```{r}
...
However, often the data will not be in that form, and some preprocessing will be needed before using those functions.
